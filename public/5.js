...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getCategory: function getCategory() {
      var that = this;
      this.$http.get("/categories/".concat(this.categoryId)).then(function (response) {
...
var render = function() {
  ...
  return _c("div", [
    _c(
      ...
      [
        _c("el-card", [
          _c("h5", [_vm._v("当前分类：" + _vm._s(_vm.category.title))])
        ]),
        _vm._v(" "),
        _c("ArticleItemBox", { attrs: { category: _vm.categoryId } })
      ],
      1
    )
  ])
