...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection outline
     ...
     * @method Grid\Column|Collection outline(string $label = null)
     ...
     * @property Show\Field|Collection outline
     ...
     * @method Show\Field|Collection outline(string $label = null)
